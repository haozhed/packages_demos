...
void choose_dial(const char *str)
{
    ...
    { // if user choose clock page
        ...
        lv_obj_align_to(AddlLabel, add_btn, LV_ALIGN_OUT_BOTTOM_MID, 0, 20);
         ...
         lv_obj_set_style_text_font(AddlLabel, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
        //lv_obj_set_style_text_font(AddlLabel, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    // lv_obj_set_style_text_font(plusLabel, font_manager_get_font(FONT_SMALL), 0);
