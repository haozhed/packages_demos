...
//     {
//         {ITEM_FLIGHT, flight_handle, get_var_flight_on, get_var_flight_off},
//         {ITEM_SETTING, setting_handle, get_var_setting_on, get_var_setting_off},
//         {ITEM_4G, _4g_handle, get_var_4g_on, get_var_4g_off},
//         {ITEM_SOUND, sound_handle, get_var_sound_on, get_var_sound_off},
//         {ITEM_BLUETOOTH, wifi_handle, get_var_wifi_on, get_var_wifi_off},
//         {ITEM_IMAGE_COUNT, bluebooth_handle, get_var_bluetooth_on, get_var_bluetooth_off},
// };
...
static void status_bar_create(lv_obj_t *screen)
{
    ...
    lv_obj_align_to(centrolCenterObj->statusBar, screen, LV_ALIGN_TOP_MID, 0, -20);
...
void control_center_start(lv_obj_t *controlCenterScreen)
{
    ...
    lv_obj_set_style_border_width(controlCenterScreen, 0, 0);
