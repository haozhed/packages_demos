...
void create_main_settings_screen(void) {
    ...
    lv_style_set_bg_color(&menu_item_style, lv_color_hex(0xf5f5f5));
    lv_style_set_bg_opa(&menu_item_style, LV_OPA_20);
    lv_style_set_radius(&menu_item_style, 15);
    lv_style_set_pad_all(&menu_item_style, 15);
    ...
    //lv_style_set_text_font(&icon_style, font_manager_get_font(FONT_SMALL));
    ...
    for (int i = 0; i < 4; i++) {
        ...
        lv_obj_set_style_bg_color(menu_item, lv_color_make(36, 32, 35), LV_PART_MAIN);
        lv_obj_set_style_border_width(menu_item, 0, LV_PART_MAIN);
        lv_obj_set_style_pad_all(menu_item, 0, LV_PART_MAIN);
        lv_obj_set_style_margin_all(menu_item, 0, LV_PART_MAIN);
        lv_obj_set_style_radius(menu_item, 20, LV_PART_MAIN);
        lv_obj_set_style_shadow_width(menu_item, 0, 0);
        lv_obj_set_style_shadow_opa(menu_item, LV_OPA_TRANSP, 0);
        ...
        lv_obj_set_style_text_font(label, font_manager_get_font(FONT_SMALL), 0);
...
void create_volume_screen(void) {
    ...
    lv_obj_set_style_bg_color(volume_screen, lv_color_black(), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(ring_label, font_manager_get_font(FONT_SMALL), 0);
    ...
    lv_obj_set_style_text_font(media_label, font_manager_get_font(FONT_SMALL), 0);
    ...
    lv_obj_add_event_cb(volume_screen, setting_gesture_event_cb, LV_EVENT_GESTURE, volume_screen);
...
void create_brightness_screen(void) {
    ...
    lv_obj_set_style_bg_color(brightness_screen, lv_color_black(), LV_PART_MAIN);
    ...
    //lv_obj_set_style_text_font(brightness_icon, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(brightness_value, lv_color_white(), LV_PART_MAIN);
     lv_obj_set_style_text_font(brightness_value, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    // 添加手势事件处理
    lv_obj_add_event_cb(brightness_screen, setting_gesture_event_cb, LV_EVENT_GESTURE, brightness_screen);
...
void create_about_screen(void) {
    ...
    lv_obj_set_style_bg_color(about_screen, lv_color_black(), LV_PART_MAIN);
    ...
    //lv_obj_set_style_text_font(app_icon, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(app_name, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(version_label, lv_color_hex(0xcccccc), LV_PART_MAIN);
     lv_obj_set_style_text_font(version_label, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(device_label, lv_color_hex(0xcccccc), LV_PART_MAIN);
     lv_obj_set_style_text_font(device_label, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(serial_label, lv_color_hex(0xcccccc), LV_PART_MAIN);
     lv_obj_set_style_text_font(serial_label, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(copyright_label, font_manager_get_font(FONT_SMALL), LV_PART_MAIN);
    ...
    // 添加手势事件处理
    lv_obj_add_event_cb(about_screen, setting_gesture_event_cb, LV_EVENT_GESTURE, about_screen);
